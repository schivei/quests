...
namespace Quests.Repositories.Extensions
{
    public static class Tar
    {
        ...
        public static void ExtractTarGz(this string filename, string outputDir)
        {
            using var stream = File.OpenRead(filename);
            stream.ExtractTarGz(outputDir);
        }
        ...
        /// <param name="outputDir">Output directory to write the files.</param>
        public static void ExtractTarGz(this Stream stream, string outputDir)
        {
        ...
        /// <param name="outputDir">Output directory to write the files.</param>
        public static void ExtractTar(this Stream stream, string outputDir)
        {
